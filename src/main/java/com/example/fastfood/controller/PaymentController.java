...
import com.example.fastfood.config.VnPayConfig;
...
public class PaymentController {
    ...
    public ResponseEntity<?> createPayment(@RequestParam long amount, HttpServletRequest req) throws UnsupportedEncodingException {
        ...
        long amountVal = amount * 100; // VNPAY yêu cầu nhân 100 (VD: 10000 đ -> 1000000)
        
        String bankCode = req.getParameter("bankCode"); // Có thể null
